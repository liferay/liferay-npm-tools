	...
	require('../../lib/lint_js_rules/' + path.basename(__filename)),
	{
		valid: [
			...
			[
				...
				{
					code:
						'var foo = () => {var f = n => {return 1}; return f();}'
				},
		...
		invalid: [
			...
			{
				code:
					'function foo() {var f = function(){if (foo) {return foo;} return 1;};}',
				errors: [
					{message: 'Functions should only have one return statement'}
				]
			}
			...
			.concat([
				...
				{
					code:
						'var foo = () => {if (x) {return x;} else {return 1;}}',
					errors: [
						{
							message:
								'Functions should only have one return statement'
				...
				{
					code:
						'var foo = () => {var f = () => {if (foo) {return foo;} return 1;};}',
					errors: [
						{
							message:
								'Functions should only have one return statement'
