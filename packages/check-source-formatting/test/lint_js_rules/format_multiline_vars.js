		...
		invalid: [
			{
				...
				errors: [
					{
						message:
							'Multi-line strings should be aligned to the start of the variable name "FOO1"'
					}
				]
			},
			{
			...
			},
			{
				...
				errors: [
					{
						message:
							'Variable values should start on the same line as the variable name "FOO1"'
					}
				]
			},
			{
			...
			[
				...
				},
				{
					...
					errors: [
						{
							message:
								'Destructured assignments should have "{" on the same line as "var"'
						}
					]
				},
				{
					...
					errors: [
						{
							message:
								'Destructured assignments should have "}" on the same line as "FOO"'
						}
					]
				}
			].map(addES6)
