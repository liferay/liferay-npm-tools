	...
	require('../../lib/lint_js_rules/' + path.basename(__filename)),
	{
		valid: [
			...
			[
				...
				{
					code:
						"({a: 1, [bar()]: 1, [foo]: 1, [obj.bar()]: 1, [obj.foo]: 1, [str + 'other']: 1 })"
				},
				{code: '({...baz, bar: 1, foo})'}
			].map(addES6)
		),
		...
		invalid: [
			{
				code:
					'({abc: function(){}, init: function(){}, initializer: function(){}, renderUI: function(){}, bindUI: function(){}, syncUI: function(){}, destructor: function(){}})',
				errors: [
					{
						message:
							'Sort properties: abc init (Lifecycle methods should come first)'
					}
				]
			},
			{
			...
			[
				...
				{
					code:
						"({a: 1, [str + 'other']: 1, [bar()]: 1, [foo]: 1, [obj.bar()]: 1, [obj.foo]: 1 })",
					errors: [
						{message: "Sort properties: [str + 'other'] [bar()]"}
					]
				}
			].map(addES6)
		)
