...
describe('CSS Rule Engine Tests', function() {
	'use strict';

	it('should detect and replace improper hex format', function() {
	...
	it('should detect and replace redundant hex colors', function() {
	...
	it('should detect and replace missing integers', function() {
	...
	it('should detect and replace list value spaces', function() {
	...
	it('should ignore list value spaces in content properties', function() {
		var rule = re.rules.css.missingListValuesSpace;
	...
	it('should detect and replace missing new lines', function() {
		var rule = re.rules.css.missingNewlines;

		var input = '.foo {';
		var output = '\n.foo {';
		var expectedWarning =
			'There should be a newline between "}" and ".foo {"';
	...
	it('should detect and replace missing new lines around directives', function() {
		var rule = re.rules.css.missingNewlines;
	...
	it('should ignore missing new lines around @else directives', function() {
		var rule = re.rules.css.missingNewlines;
	...
	it('should detect missing selector space', function() {
	...
	it('should detect and replace missing combinator space', function() {
		...
		_.forEach(inputs, function(output, input) {
		...
		_.forEach(ignoreInputs, function(input, index) {
			var context = {
				content: input,
				rawContent: input
			};
	...
	it('should detect and replace needless quotes', function() {
	...
	it('should detect and replace needless units', function() {
	...
	it('should detect trailing newlines', function() {
	...
	it('should ignore newlines around comments in nested selectors', function() {
		var rule = re.rules.css.trailingNewlines;
	...
	it('should detect and replace trailing commas in selector', function() {
	...
	it('should detect and replace invalid border reset', function() {
		var rule = re.rules.css._properties.invalidBorderReset;
		var prop = 'border';

		var input = ['', 'top', 'right', 'bottom', 'left'].reduce(function(
			prev,
			item,
			index
		) {
	...
	it('should detect and replace invalid property format', function() {
		var rule = re.rules.css._properties.invalidFormat;

		var input = ['width:10px;', 'width:	10px;', 'width:    10px;'];
